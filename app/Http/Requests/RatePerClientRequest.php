...
class RatePerClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'container_size' => [
                'required',
                'string',
                Rule::in(['20ft', '40ft', '45ft', '20ft(offhire)', '40ft(offhire)', '45ft(offhire)']),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'container_size.in' => 'The container size must be one of: 20ft, 40ft, 45ft, 20ft(offhire), 40ft(offhire), or 45ft(offhire).',
