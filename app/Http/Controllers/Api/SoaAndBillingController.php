...
class SoaAndBillingController extends BaseController
{
    ...
    /**
     * @OA\Get(
     *     path="/api/soa_and_billing",
     *     summary="Get list of statement of accounts",
     *     tags={"soa_and_billing"},
     *     security={{"sanctum": {}}},
    ...
    /**
     * @OA\Post(
     *     path="/api/soa_and_billing/generate",
    ...
    /**
     * @OA\Get(
     *     path="/api/soa_and_billing/{id}/download",
