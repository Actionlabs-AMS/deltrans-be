 ...
 *     @OA\Property(property="has_billing_statement", type="boolean", example=true, description="Whether a billing statement is attached to this SOA"),
 *     @OA\Property(property="billing_statement_id", type="integer", example=5, nullable=true, description="Linked billing statement id when generated"),
 *     @OA\Property(property="billing_statement_number", type="string", example="BS-2024-001", nullable=true, description="Linked billing statement number for badge display"),
 *     @OA\Property(property="has_invoice", type="boolean", example=true, description="Whether an invoice is attached to this SOA"),
 *     @OA\Property(property="invoice_id", type="integer", example=8, nullable=true, description="Linked invoice id when generated"),
 *     @OA\Property(property="invoice_number", type="string", example="INV-0001", nullable=true, description="Linked invoice number for badge display"),
 ...
 *     @OA\Property(property="has_invoice", type="boolean", example=true, description="Whether an invoice is attached via the linked SOA"),
 *     @OA\Property(property="invoice_id", type="integer", example=8, nullable=true, description="Linked invoice id when generated"),
 *     @OA\Property(property="invoice_number", type="string", example="INV-0001", nullable=true, description="Linked invoice number for badge display"),
