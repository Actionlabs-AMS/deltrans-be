 ...
 *     @OA\Property(property="stack_run_rate", type="number", format="float", example=100.00, description="From waybill_details.stack_run"),
 *     @OA\Property(property="stack_run_fixed", type="number", format="float", example=150.00, nullable=true, description="From fixed_expenses.stack_run where fixed_expenses.id = waybill_details.fixed_expense_id"),
 ...
 *     @OA\Property(property="purchase_order", type="string", example="PO-2025-001", nullable=true, description="Resolved from diesel_expenses.purchase_order using waybill_details.diesel_expense_id"),
 ...
 *     @OA\Property(property="purchase_order", type="string", example="PO-2025-001", nullable=true, description="Creates/updates diesel_expenses.purchase_order"),
